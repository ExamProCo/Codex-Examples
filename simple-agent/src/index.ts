...
const assistant = new Agent({
  ...
  instructions:
    'You are a concise assistant. Use the time tool when the user asks about the current time or date.',
...
async function main() {
  const initialInput =
    prompt || 'Introduce yourself in 2 short sentences and tell me what tools you can use.';
